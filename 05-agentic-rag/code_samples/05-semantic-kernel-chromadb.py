   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/home/yexin/.cache/chroma/onnx_models/all-MiniLM-L6-v2/onnx.tar.gz: 100%|██████████| 79.3M/79.3M [00:01<00:00, 76.1MiB/s]\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "\n",
       "- **Medical Emergencies:** Coverage for medical emergencies that may arise during your trip.\n",
       "- **Trip Cancellations:** Protection against financial loss in case you need to cancel your trip.\n",
       "- **Lost Baggage:** Coverage for baggage that is lost during your travels.\n",
       "\n",
       "This insurance helps ensure that travelers are protected against unexpected events that can disrupt their trips.</div></div><hr>"
      ],
      "text/plain": [
